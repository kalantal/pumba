...
export watcher=./results/watcher.log
...
docker run -id --name pumba_tester "$container_name" >& $watcher
#docker run -id --name pumba_tester docker-enterprise-dev-local.artifactrepository.citigroup.net/cate-citisystems-soe-rhel/rhel7:2016q3_b0 >& $watcher
}
docker_build_container
